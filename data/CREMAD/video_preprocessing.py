...
class CRAMED_dataset(object):
    def __init__(self, path_to_dataset=r'/root/autodl-tmp/CREMAD', frame_interval=1, frame_kept_per_second=1):
        ...
        self.path_to_save_audio = os.path.join(path_to_dataset, 'Audio-{:d}'.format(299))
